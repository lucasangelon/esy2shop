...
public class ListAdapter extends BaseAdapter {
    ...
    //needs getList method, not neccessary atm
    @Override
    public long getItemId(int position) {
        return 0;
    }
    ...
    public View getView(int postion, View convertView, ViewGroup parent) {
        ...
        View V = convertView;
        final int finalPos = postion;

        if(V == null) {
            LayoutInflater layoutInflater = (LayoutInflater)mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            V = layoutInflater.inflate(R.layout.activity_main_menu, null);
        }

        final List lit = list.get(finalPos);

        // Text View, change later to List View
     //   final TextView txt = (TextView)V.findViewById(R.id.it)
        return V;
    }
    */
}
